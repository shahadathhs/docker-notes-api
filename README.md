# Docker Cheat Sheet & notes-api

Docker, explained through a real backend application — companion repo for the Medium article:
...
- **A working demo app** — a Node.js + TypeScript notes API with PostgreSQL, built and shipped with Docker, from a naive **1.71 GB** image down to a **356 MB** production build. The full article text is in [`ARTICLE.md`](ARTICLE.md).
- **A Docker cheat sheet** — the complete command reference below, from beginner to expert.
